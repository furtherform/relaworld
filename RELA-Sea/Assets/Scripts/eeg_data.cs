...
public class eeg_data  // removed static from this, possible issues?
...

{
	...
	public static float eeg2;	//relaxation, fades to whie.
	public static float eeg1;  //concentration, goes up and down
